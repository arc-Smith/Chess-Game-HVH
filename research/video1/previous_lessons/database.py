...
def query():
	...
	query_label.grid(row=11, column=0, columnspan=1)
...
submit_btn.grid(row=6, column=0, columnspan=1, pady=10, padx=0, ipadx=137)

# Create a Query Button
query_btn = Button(root, text="Show Records", command=query)
query_btn.grid(row=7, column=0, columnspan=1, pady=10, padx=0, ipadx=137)

# Create A Delete Button
delete_btn = Button(root, text="Delete Record", command=delete)
delete_btn.grid(row=10, column=0, columnspan=1, pady=10, padx=0, ipadx=136)
